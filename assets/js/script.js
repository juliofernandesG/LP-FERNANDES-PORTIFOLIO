...
function filtrarItens(categoriaSelecionada) {
  const itens = document.querySelectorAll('.col-md-6.col-lg-4');
  itens.forEach((item) => {
...
// Adicione um evento de clique aos botões de categoria
...
btnCategorias.forEach((btn) => {
  btn.addEventListener('click', (event) => {
    ...
    filtrarItens(categoriaSelecionada);
  });
});
